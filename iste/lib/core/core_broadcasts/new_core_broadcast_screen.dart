...
class NewCoreBroadcastScreen extends StatefulWidget {
  const NewCoreBroadcastScreen({Key? key}) : super(key: key);

  @override
  _NewCoreBroadcastScreenState createState() => _NewCoreBroadcastScreenState();
}

class _NewCoreBroadcastScreenState extends State<NewCoreBroadcastScreen> {
  ...
  Future sendData(String description, BuildContext context) async {
    ...
    final String url = "https://vit-iste.herokuapp.com/e8b13f8eebf238007d1aa38e4b57ac1d3bb8c3d5631ba826c9a81e9cd19c79b4/core";
    ...
    print(response.body);
    print("data added!!!");
    Navigator.of(context).pushNamedAndRemoveUntil(SuccessCoreBroadcastScreen.routeName, (route) => false);
  }
