...
class CoreBroadcastScreen extends StatefulWidget {
  const CoreBroadcastScreen({Key? key}) : super(key: key);

  @override
  _CoreBroadcastScreenState createState() => _CoreBroadcastScreenState();
}

class _CoreBroadcastScreenState extends State<CoreBroadcastScreen> {
  bool isLoading = true;
  ...
  Future getData() async {
    ...
    String url = "https://vit-iste.herokuapp.com/e8b13f8eebf238007d1aa38e4b57ac1d3bb8c3d5631ba826c9a81e9cd19c79b4/core";
              ...
              : Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      onTap: () => {Navigator.pushNamed(context, "/new_core_broadcast_screen")},
                    ),
                    data.length == 0 ? SizedBox(height: 0.26 * c) : SizedBox(height: 0.026 * c),
                    data.length == 0
                        ? Center(
                            child: Text(
                              "No new broadcasts :)",
