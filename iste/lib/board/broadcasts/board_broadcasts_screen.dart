...
class BoardBroadcastsScreen extends StatefulWidget {
  const BoardBroadcastsScreen({Key? key}) : super(key: key);

  @override
  _BoardBroadcastsScreenState createState() => _BoardBroadcastsScreenState();
}

class _BoardBroadcastsScreenState extends State<BoardBroadcastsScreen> with AutomaticKeepAliveClientMixin<BoardBroadcastsScreen> {
  bool isLoading = true;
              ...
              : Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      onTap: () => Navigator.pushNamed(context, "/new_broadcast_screen"),
                    ),
