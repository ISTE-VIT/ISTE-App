...
class RequestDeletedScreen extends StatelessWidget {
  static const routeName = "/request_deleted_screen";
        ...
        child: Scaffold(
          ...
          body: SafeArea(
            ...
            child: Container(
              ...
              child: Text(
                "Request rejected successfully! Redirecting you to the home-screen",
                style: TextStyle(
                  fontFamily: "Poppins",
                  fontSize: 0.065 * c,
