...
class RequestAddedScreen extends StatelessWidget {
  static const routeName = "/request-added-screen";
        ...
        child: Scaffold(
          ...
          body: SafeArea(
            ...
            child: Container(
              ...
              child: Text(
                "Request approved successfully! Redirecting you to the home-screen",
                style: TextStyle(
                  fontFamily: "Poppins",
                  fontSize: 0.065 * c,
